...
fields[#fields + 1] = { t = "Yaw precomp.",        x = x, y = incY(lineSpacing), sp = x + sp, data = governorProfile.yaw_weight,           id = "govYawPrecomp" }
fields[#fields + 1] = { t = "Cyclic precomp.",     x = x, y = incY(lineSpacing), sp = x + sp, data = governorProfile.cyclic_weight,        id = "govCyclicPrecomp" }
fields[#fields + 1] = { t = "Coll precomp.",       x = x, y = incY(lineSpacing), sp = x + sp, data = governorProfile.collective_weight,    id = "govCollectivePrecomp" }
