...
local endEscEditing = function(field, page)
    ...
    rf2.useApi("mspEscBlheliS").read(receivedEscParameters, page)
end

receivedEscParameters = function(page, data)
    escParameters = data
    clearForm(page)
    page.labels, page.fields = rf2.executeScript("PAGES/esc_blhelis_form", escParameters, escCount, selectedEsc, endEscEditing)
    page.readOnly = false
...
page.labels, page.fields = rf2.executeScript("PAGES/esc_blhelis_form", nil)
