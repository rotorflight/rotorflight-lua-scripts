...
fields[3] = { t = "BEC Voltage",        x = x,          y = inc.y(lineSpacing), sp = x + sp, min = 54, max = 84, vals = { 2 + 68 }, scale = 10 }
...
return {
    ...
    postLoad = function(self)
        ...
        l.t = getText(self.values, 2 + 49, 15)

        -- HW ver
        l = self.labels[2]
        l.t = getText(self.values, 2 + 17, 15)

        -- FW ver
        l = self.labels[3]
        l.t = getText(self.values, 2 + 1, 15)
