...
fields[#fields + 1] = {              x = x, y = inc.y(tableSpacing.row), min = 0, max = 200, vals = { 10 } }
...
fields[#fields + 1] = {              x = x, y = inc.y(tableSpacing.row), min = 0, max = 200, vals = { 11 } }
...
fields[#fields + 1] = {              x = x, y = inc.y(tableSpacing.row), min = 0, max = 200, vals = { 12 } }
