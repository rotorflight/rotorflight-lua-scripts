...
fields[#fields + 1] = { t = "Cyclic",                  x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 250, vals = { 27 }, table = { [0] = "ABSOLUTE", "LINEAR", "NATURAL" } }
fields[#fields + 1] = { t = "Collective",              x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 250, vals = { 28 }, table = { [0] = "ABSOLUTE", "LINEAR", "NATURAL" } }
...
fields[#fields + 1] = { t = "Col. FF Imp Freq",        x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 250, vals = { 26 } }
...
fields[#fields + 1] = { t = "Climb Collective",        x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 1000, vals = { 29, 30 } }
fields[#fields + 1] = { t = "Init. Climb Boost",       x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 1000, vals = { 31, 32 } }
fields[#fields + 1] = { t = "Init. Climb Dura.",       x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 100, vals = { 33 } }

labels[#labels + 1] = { t = "Governor",                x = x,          y = inc.y(lineSpacing) }
fields[#fields + 1] = { t = "Full Headspeed",          x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 10000, vals = { 34, 35 }, mult = 10}
fields[#fields + 1] = { t = "PID Master Gain",         x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 200, vals = { 36 } }
fields[#fields + 1] = { t = "P-gain",                  x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 200, vals = { 37 } }
fields[#fields + 1] = { t = "I-gain",                  x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 200, vals = { 38 } }
fields[#fields + 1] = { t = "D-gain",                  x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 200, vals = { 39 } }
fields[#fields + 1] = { t = "F-gain",                  x = x + indent, y = inc.y(lineSpacing), sp = x + sp, min = 0, max = 200, vals = { 40 } }
